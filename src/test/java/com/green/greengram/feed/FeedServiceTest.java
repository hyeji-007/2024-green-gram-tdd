...
class FeedServiceTest {
    ...
    void test2() throws Exception {
        ...
        given(feedMapper.insFeed(givenParam)).will(invocation -> {
            FeedPostReq invocationParam = (FeedPostReq) invocation.getArgument(0); //insFeed(p), p=0
            invocationParam.setFeedId(FEED_ID_10); //p.getFeedId()에 FEED_ID_10
            return 1;
        });
    ...
    @Test
    @DisplayName("test2와 같은 맥락, 파일을 2개로 테스트 함.")
